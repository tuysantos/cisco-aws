...
import { DashboardAwsComponent } from './dashboard-aws.component';
...
describe('DashboardAwsComponent', () => {
  let component: DashboardAwsComponent;
  let fixture: ComponentFixture<DashboardAwsComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ DashboardAwsComponent, ActivityListComponent, SummaryActivityComponent, PaginationComponent, SearchComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DashboardAwsComponent);
